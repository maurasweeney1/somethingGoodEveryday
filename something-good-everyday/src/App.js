...
function App() {
  ...
  const updateColorTheme = (isLightMode) => {
    ...
    if (isLightMode) {
      ...
      // document.querySelectorAll("button").classList.remove("dark-mode");
      // document.querySelectorAll("button").classList.add("light-mode");
    } else {
      document.body.classList.remove("light-mode");
      document.body.classList.add("dark-mode");
      document.querySelector("header").classList.remove("light-mode");
      document.querySelector("header").classList.add("dark-mode");
      // document.querySelectorAll("button").classList.remove("light-mode");
      // document.querySelectorAll("button").classList.add("dark-mode");
    }
  };
